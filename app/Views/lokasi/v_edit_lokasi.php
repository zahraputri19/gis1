    ...
    <div class="col-sm-4">
        <div class="row">
            ...
            <div class= "form-group">
                ...
                <input class="form-control" name="latitude" value="<?= $lokasi['latitude'] ?>" id="Latitude">
                <p class="text-danger"><?=  isset($errors['latitude'])==isset($errors['latitude'])? validation_show_error('latitude') : '' ?></p>
            </div>
            <div class= "form-group">
                <label>Longitude</label>
                <input class="form-control" name="longitude" value="<?= $lokasi['longitude'] ?>" id="Longitude">
            ...
            <a href="<?= base_url('Lokasi/index') ?>" class="btn btn-success">Kembali</button>
            <?php echo form_close() ?>
        </div>
    </div>
</div>
